...
export default (({}) => {
    ...
    return (
        <SocialShareButtons className="socialShareButtons">
            <a onClick={_shareOnFacebook} role="button" className="currencyBackground--hover">
            ...
            <a className="currencyBackground--hover" onClick={(e) => {e.preventDefault();window.open(`https://twitter.com/intent/tweet?&original_referer=${URL}/&text=${twitterMessage}&tw_p=tweetbutton&url=${URL}`,'popup','width=600,height=600,scrollbars=no,resizable=no'); return false;}} role="button">
